...
| **AI / Agentic** | LangGraph, LangChain, OpenAI API, RAG (ChromaDB) |
| **ML** | Scikit-learn, TensorFlow/Keras, TF-IDF, NLP, Sentiment Analysis |
| **Computer Vision** | OpenCV, YOLOv8, OpenCLIP, BLIP, MediaPipe |
| **Web / Backend** | React, Node.js, Express, Flask, REST APIs |
| **Databases** | PostgreSQL, SQLite, MySQL |
| **Scraping & Automation** | Playwright, Selenium, BeautifulSoup, smtplib |
| **Tools** | VSCode, Jupyter, Google Colab, Git, Gradio, Matplotlib, Seaborn |
...
### ⬇️ [Smart Downloader](https://github.com/nb-hmd/Smart-Downloader)
> Python

Intelligent file downloader with queue management, progress tracking, and automation features for handling bulk downloads efficiently.

---

### 🕵️ [AI Content Detection & Removal](https://github.com/nb-hmd/AI-Content-Detection-and-Removal)
> Python · NLP

Detects AI-generated content within text using classifier models and removes or flags it — useful for content moderation and authenticity verification pipelines.

---

### 🧩 [Sudoku Solver with OpenCV](https://github.com/nb-hmd/Sudoku-Solver-with-OpenCV)
> Python · OpenCV

Real-time Sudoku puzzle detection and solving directly from a webcam feed. Uses OpenCV for grid extraction and digit recognition to identify and solve the puzzle on screen.

---

### 🐦 [Twitter Sentiment Analysis](https://github.com/nb-hmd/Twitter_Sentiment_Analysis)
> Python · Scikit-learn · NLP

NLP pipeline for classifying tweet sentiment using TF-IDF vectorization and machine learning classifiers, with preprocessing and evaluation across positive, negative, and neutral categories.
...
**Software Developer Intern** — Heavy Industries Taxila (HIT) | Jul–Aug 2025
> Built the HIT Ticket Management System for a national defense manufacturing organization.
